...
public class Selection<K> implements Iterable<K> {
    ...
    public String toString() {
        ...
        buffer.append("primary{size=" + this.mSelection.size());
        buffer.append(", entries=" + this.mSelection);
        buffer.append("}, provisional{size=" + this.mProvisionalSelection.size());
        buffer.append(", entries=" + this.mProvisionalSelection);
        buffer.append("}}");
