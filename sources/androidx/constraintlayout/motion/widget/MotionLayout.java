    ...
    class Model {
        ...
        public void measure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            if (recompute_start_end_size) {
                ...
                MotionLayout.this.mHeightMeasureMode = heightMode;
                if (MotionLayout.this.mCurrentState == MotionLayout.this.getStartState()) {
                    MotionLayout.this.resolveSystem(this.mLayoutEnd, optimisationLevel, this.mEnd.mRotate == 0 ? widthMeasureSpec : heightMeasureSpec, this.mEnd.mRotate == 0 ? heightMeasureSpec : widthMeasureSpec);
                    ConstraintSet constraintSet7 = this.mStart;
                    if (constraintSet7 != null) {
                        MotionLayout.this.resolveSystem(this.mLayoutStart, optimisationLevel, constraintSet7.mRotate == 0 ? widthMeasureSpec : heightMeasureSpec, this.mStart.mRotate == 0 ? heightMeasureSpec : widthMeasureSpec);
                    }
                } else {
                    ConstraintSet constraintSet8 = this.mStart;
                    if (constraintSet8 != null) {
                        MotionLayout.this.resolveSystem(this.mLayoutStart, optimisationLevel, constraintSet8.mRotate == 0 ? widthMeasureSpec : heightMeasureSpec, this.mStart.mRotate == 0 ? heightMeasureSpec : widthMeasureSpec);
                    }
                    MotionLayout.this.resolveSystem(this.mLayoutEnd, optimisationLevel, this.mEnd.mRotate == 0 ? widthMeasureSpec : heightMeasureSpec, this.mEnd.mRotate == 0 ? heightMeasureSpec : widthMeasureSpec);
                }
            ...
            while (i2 < n) {
                ...
                if (motionController2 == null) {
                    ...
                    if (this.mStart != null) {
                        ...
                        int access$2500 = MotionLayout.this.mPreRotateWidth;
                        int access$2600 = MotionLayout.this.mPreRotateHeight;
                        controllers = controllers2;
                        str = MotionLayout.TAG;
                        motionController2.setStartState(MotionLayout.this.mPreRotate.get(v2), v2, i3, access$2500, access$2600);
                    } else {
                        controllers = controllers2;
                        str = MotionLayout.TAG;
                    }
