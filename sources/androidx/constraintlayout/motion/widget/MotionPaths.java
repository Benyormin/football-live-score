        ...
        while (true) {
            ...
            if (i2 < dArr2.length) {
                ...
                if (motionController != null) {
                    ...
                    Double.isNaN(d4);
                    double d6 = d4 + (d5 * sin);
                    double d7 = (double) (v_width3 / 2.0f);
                    Double.isNaN(d7);
                    ...
                    if (!Float.isNaN(path_rotate2)) {
                        ...
                        Double.isNaN(d23);
                        view2 = view;
                        view2.setRotation((float) (d23 + degrees));
                    } else {
                        float f16 = ry;
                        float f17 = dpos_x;
                        float f18 = dpos_y;
                        float f19 = path_rotate2;
                        view2 = view;
                        float path_rotate5 = angle2;
                    }
                    float pos_x2 = dv_x2;
                    float f20 = dv_y2;
                    v_y = v_y6;
